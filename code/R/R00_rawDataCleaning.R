...
## Load data
dataG1 <- read.csv("../../dataIn/raw data Joshka Kostas/data-G1-Kostas_JK.csv")
dataAll <- read.csv("../../dataIn/raw data Joshka Kostas/Kostas_G2_info.csv")
key <- read.csv("../../dataIn/raw data Joshka Kostas/key_matchV48_clutchID_G2_Alice.csv")
...
write.csv(cleanDF, "../../dataIn/cleanedRawData144fishG1G2.csv", quote = F, row.names = F)
...
write.csv(cleanDF[cleanDF$clutch.ID %in% clutch.ID2keep,], 
          "../../dataIn/cleanedRawData132fishG1G2.csv", quote = F, row.names = F)
