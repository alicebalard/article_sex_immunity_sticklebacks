## Custom functions for article sex and immunity Stickleback

getDiffMethSex <- function(myuniteCov, myMetadata, mccores=10, mydif = 15){
...
############# functions from previous paper (to clean)
